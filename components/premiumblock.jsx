...
export default function PremiumBlock({ visibility }) {
    return (
        <div className={`flex flex-col items-center justify-center absolute h-full ${visibility ? "visible" : "collapse"}`} style={{ marginBottom: "150px", maxWidth: "600px", top: "1%", right: "5%" }}>
